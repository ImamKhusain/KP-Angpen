...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Feb 2026 pada 13.26
...
--
-- Struktur dari tabel `kode_daerah`
--

CREATE TABLE `kode_daerah` (
  `kode_awal` char(4) NOT NULL,
  `asal_daerah` varchar(150) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data untuk tabel `kode_daerah`
--
...
--
-- Indeks untuk tabel `kode_daerah`
--
