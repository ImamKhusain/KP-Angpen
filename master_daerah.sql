...
--
-- Host: localhost:3306
-- Generation Time: Feb 22, 2026 at 10:45 AM
...
CREATE TABLE `kode_daerah` (
  `kode_awal` char(4) COLLATE utf8mb4_general_ci NOT NULL,
  `asal_daerah` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL
...
INSERT INTO `kode_daerah` (`kode_awal`, `asal_daerah`) VALUES
...
('1607', 'KAB. BANYUASIN'),
('1608', 'KAB. OGAN KOMERING ULUTIMUR'),
('1609', 'KAB. OGAN KOMERING ULUSELATAN'),
('1610', 'KAB. OGAN ILIR'),
('1611', 'KAB. EMPAT LAWANG'),
('1612', 'KAB. PENUKAL ABAB LEMATANGILIR'),
...
('7108', 'KAB. BOLAANG MONGONDOWUTARA'),
('7109', 'KAB. KEP. SIAU TAGULANDANGBIARO'),
('7110', 'KAB. BOLAANG MONGONDOWTIMUR'),
('7111', 'KAB. BOLAANG MONGONDOWSELATAN'),
('7171', 'KOTA MANADO'),
('7172', 'KOTA BITUNG'),
('7173', 'KOTA TOMOHON'),
...
INSERT INTO `stasiun` (`id`, `kode_stasiun`, `nama_stasiun`, `created_at`) VALUES
(1, 'MN', 'Madiun', '2026-02-22 07:51:21'),
(2, 'KTS', 'Kertosono', '2026-02-22 07:51:21'),
(3, 'JG', 'Jombang', '2026-02-22 07:51:21'),
(4, 'TA', 'Tulungagung', '2026-02-22 07:51:21'),
(5, 'BL', 'Blitar', '2026-02-22 07:51:21'),
(6, 'KD', 'Kediri', '2026-02-22 07:51:21');
...
(1, 'Andika Dwi Saktiawan', '$2y$10$vZ8ZWIIuiDq3495.WS0wIe5Dt1wjyL8lbmBxJipg2gnwwaL6BQA2C'),
(2, 'admin', '$2y$12$uBG8PAJvcrChqonURZ0b7.3To8k5AEgeJEBm8xbDsF.SZQ3Ettw9a');
